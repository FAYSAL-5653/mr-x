                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                <div class="bg-light p-4 rounded-4">
                                    <div class="text-secondary fw-bolder mb-2">${item['durations']}</div>
                                    <div class="mb-2">
                                        <div class="small fw-bolder">${item['institution_name']}</div>
                                    </div>
                                    <div class="fst-italic">
                                        <div class="small text-muted">${item['filde']}</div>
